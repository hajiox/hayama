...
title: {
  default: "【公式】麓山高原豚チャーシュー｜ラーメン屋が作る本物のチャーシュー｜会津ブランド館",
  template: "%s | 会津ブランド館",
},
description:
  "たどり着いた、チャーシューの最高峰。福島県産ブランド豚『麓山高原豚チャーシュー』誕生。炭酸低温煮込みと秘伝のタレで仕上げた、しっとり柔らかな本格チャーシュー。Amazon・楽天・Yahoo!ランキング1位獲得。ご自宅でラーメン屋のチャーシューを。ギフトにも最適。送料無料・即日発送（沖縄・離島除く）。",
keywords:
...
openGraph: {
  title: "【公式】麓山高原豚チャーシュー｜ラーメン屋が作る本物のチャーシュー｜会津ブランド館",
  description:
    "福島県産ブランド豚『麓山高原豚』を炭酸低温煮込みと秘伝のタレで仕上げた本格チャーシュー。しっとり柔らかな赤身ととろける脂身が特徴。ラーメン屋が作る本物のチャーシュー。Amazon・楽天・Yahoo!ランキング1位獲得。",
...
twitter: {
  ...
  title: "【公式】麓山高原豚チャーシュー｜ラーメン屋が作る本物のチャーシュー｜会津ブランド館",
  description:
    "福島県産ブランド豚『麓山高原豚』を炭酸低温煮込みと秘伝のタレで仕上げた本格チャーシュー。しっとり柔らかな赤身ととろける脂身が特徴。ラーメン屋が作る本物のチャーシュー。",
  images: [
    {
      url: "/images/ogp-chashu.jpg", // publicディレクトリからの相対パス
      alt: "麓山高原豚チャーシューの盛り付け写真",
