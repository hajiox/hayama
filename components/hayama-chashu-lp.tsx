  ...
  const reviews = [
    {
      ...
      title: "想像以上にとろける赤身！",
      rating: 5,
      body: "脂身だけでなく、赤身までやわらかいなんて初めて。口に入れた瞬間、ふわっとほどけました。",
    },
    {
      name: "お客様２",
      title: "臭みゼロでびっくり",
      rating: 5,
      body: "正直、外国産獣臭が苦手だったんですが、これはまったく気にならない！国産の良さを実感しました。",
    },
    {
      name: "お客様３",
      title: "冷凍なのに出来たてレベル",
      rating: 4,
      body: "冷凍で届いたとは思えないほどジューシーで柔らかい。ストックしておいても味が落ちないのが嬉しいです。",
    },
    {
      name: "お客様４",
      title: "炒飯の具にも最高",
      rating: 5,
      body: "カットして炒飯に入れたら家族に大好評。香りも食感も贅沢すぎるほどのチャーシューです。",
    },
    {
      name: "お客様５",
      title: "付属のタレが美味しすぎてご飯が止まらない",
      rating: 4,
      body: "チャーシューの旨みがしみたタレが絶品。ご飯にかけるだけで立派なおかずになります！",
    },
    {
      name: "お客様６",
      title: "ラーメン屋超えました…",
      rating: 5,
      body: "近所のラーメン屋より美味しいかも…。このクオリティが家で食べられるのは本当にありがたいです。",
    },
    {
      name: "お客様７",
      title: "プレゼントにしたら喜ばれました",
      rating: 4,
      body: "父の日に贈ったら、「こんなチャーシュー初めて食べた」と感動してました。ギフトにもおすすめ。",
    },
    {
      name: "お客様８",
      title: "食感がプロの仕上がり",
      rating: 5,
      body: "しっとり、でも崩れない絶妙な火入れ。まさに職人の仕事って感じです。",
    },
    {
      name: "お客様９",
      title: "麺よりチャーシューが主役に",
      rating: 4,
      body: "ラーメンを作ったけど、チャーシューが主役になってしまった…。それぐらい存在感あります。",
    },
    {
      name: "お客様１０",
      title: "リピート確定です！",
      rating: 5,
      body: "最初は試しに1パックだけ注文したけど、すぐにまとめ買いしました。冷凍庫に常備したい！",
    },
  ]
      ...
      <section className="bg-rose-50 py-8">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
            <Image
              src="/images/rakuten-rank-1-item1.jpg"
              alt="楽天ランキング1位獲得"
              width={210}
              height={120}
              className="rounded border bg-white w-full h-auto object-contain"
            />
            <Image
              src="/images/rakuten-rank-1-item2.jpg"
              alt="楽天ランキング1位獲得"
              width={210}
              height={120}
              className="rounded border bg-white w-full h-auto object-contain"
            />
            <Image
              src="/images/rakuten-rank-1-item3.jpg"
              alt="楽天ランキング1位獲得"
              width={210}
              height={120}
              className="rounded border bg-white w-full h-auto object-contain"
            />
            <Image
              src="/images/yahoo-rank-1-item1.jpg"
            ...
            />
            <Image
              src="/images/yahoo-rank-1-item2.jpg"
              alt="Yahoo!ショッピングカテゴリランキング1位獲得"
              width={210}
              height={120}
              className="rounded border bg-white w-full h-auto object-contain"
            />
            <Image
              src="/images/yahoo-rank-2-item1.jpg"
              alt="Yahoo!ショッピングカテゴリランキング2位入賞"
              width={210}
              height={120}
              className="rounded border bg-white w-full h-auto object-contain"
            />
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-[17px] leading-relaxed text-gray-700 space-y-4 font-sans">
              ...
              <p>冷凍流通が主流の輸入豚とは異なり、冷蔵流通による鮮度の高さも大きな魅力です。</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="space-y-3">
              <div className="relative aspect-square w-full">
                <Image
                  src="/images/akami-yawarakasa.jpg"
                  alt="赤身の柔らかさ"
                  fill
                  className="object-cover rounded-lg"
                />
            ...
            <div className="space-y-3">
              <div className="relative aspect-square w-full">
                <Image src="/images/nioi-sukunasa.jpg" alt="臭みの少なさ" fill className="object-cover rounded-lg" />
              </div>
            ...
            <div className="space-y-3">
              <div className="relative aspect-square w-full">
                <Image src="/images/sendo-sa.jpg" alt="鮮度の差" fill className="object-cover rounded-lg" />
              </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="flex flex-col gap-12">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="relative aspect-[4/3] w-full">
                <Image
                  src="/images/tansan-yawarakasa.jpg"
                  alt="炭酸低温煮込みのイメージ"
                  fill
                  className="object-cover rounded-lg"
                />
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="relative aspect-[4/3] w-full md:order-2">
                <Image src="/images/IMG_9059.jpg" alt="秘伝のたれのイメージ" fill className="object-cover rounded-lg" />
              </div>
            ...
            {products.map((p, i) => (
              <Card key={i} className="overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                ...
                <CardContent className="flex flex-col h-full">
                  ...
                  {p.sauceNote && <p className="text-sm text-gray-700 mt-1 font-sans">{p.sauceNote}</p>}
                  {p.storageInfo && <p className="text-sm text-gray-700 mt-1 font-sans">{p.storageInfo}</p>}
                </CardContent>
              </Card>
            ))}
          </div>
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="relative aspect-[3/1] w-full">
              <Image
                src="/images/same-day-shipping.jpg"
                alt="14時までのご注文で即日発送"
                fill
                className="object-contain"
              />
          ...
          <div className="space-y-6 font-sans">
            <div className="border-b pb-4">
              <h3 className="font-semibold text-lg mb-2 font-heading">
                Q1. 黒っぽい筋や斑点がありますが、大丈夫ですか？
              </h3>
              <p className="text-gray-700">
                A.
                はい、ご安心ください。豚肉には血管や血液の一部が残ることがあり、加熱によって黒く変色して見えることがあります。特に国産豚は冷蔵のまま加工するため血合いが残りやすい傾向がありますが、衛生面・品質面に問題はありません。
              </p>
            </div>
            <div className="border-b pb-4">
              ...
              <p className="text-gray-700">
                A.
                はい、本商品は脂身のしっかり入った豚バラ肉を使用しています。麓山高原豚ならではのとろけるような脂身と上品な甘みが特徴で、多くのお客様にご好評いただいています。ただし、脂身が苦手な方には重く感じる場合もあるため、ご購入をお控えいただくことをおすすめいたします。
              </p>
            </div>
            <div className="border-b pb-4">
              <h3 className="font-semibold text-lg mb-2 font-heading">
                Q3. 冷凍で届くとのことですが、味は落ちませんか？
              </h3>
              <p className="text-gray-700">
                A.
                ご安心ください。商品は真空パック後、最新の冷凍技術で急速冷凍しております。解凍後もジューシーさと柔らかさを損なうことなく、美味しくお召し上がりいただけます。
              </p>
            </div>
            <div className="border-b pb-4">
              ...
              <p className="text-gray-700">
                A.
                冷凍保存で製造日より1年間の賞味期限があります。解凍後は未開封で冷蔵3日以内にお召し上がりください。開封後は風味が損なわれやすいため、なるべくお早めにお召し上がりください。
              </p>
            </div>
            <div className="pb-4">
              <h3 className="font-semibold text-lg mb-2 font-heading">Q5. たれはついていますか？</h3>
              <p className="text-gray-700">
                A. はい、<strong>チャーシュー専用の特製たれ（80cc）</strong>
                が1本付属します。本みりんと日本酒を使用し、チャーシューの旨みをさらに引き立てる仕上がりにしています。温めたチャーシューにかけて、ご飯や麺との相性をぜひお楽しみください。
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            ...
            <div className="bg-[#e8ffdd] p-6 rounded-lg">
              ...
              >
                <div className="bg-white p-4 mx-auto max-w-[200px] aspect-square flex flex-col items-center justify-center rounded-lg border-2 border-gray-200 hover:shadow-lg transition-shadow mb-4">
                  <Image src="/images/btn-amazon.png" alt="Amazon" width={200} height={200} className="w-full h-auto" />
                </div>
              </Link>
